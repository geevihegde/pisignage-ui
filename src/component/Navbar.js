    ...
    return(
        <div className="h-screen flex overflow-hidden bg-gray-100">
            ...
            <div className="md:hidden">
                ...
                <Transition 
                    ...
                    leaveTo="-translate-x-full">
                        {(ref)=>(
                            <div ref={ref} className="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-gray-800">
                    <div className="absolute top-0 right-0 -mr-12 pt-2">
                    <button onClick={()=>setCloseSideBar(!closeSideBar)} className="ml-1 flex items-center justify-center h-10 w-10 rounded-full focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
            ...
            <div className="flex flex-col w-0 flex-1 overflow-hidden">
                ...
                <button onClick={()=>setCloseSideBar(!closeSideBar)} className="px-4 border-r border-gray-200 text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500 md:hidden">
                ...
                <div className="flex-1 px-4 flex justify-between">
                    ...
                    <div className="ml-3 relative">
                        <div>
                        <button onClick={()=>setProfileShow(!profileShow)} className="max-w-xs bg-white flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" id="user-menu" aria-haspopup="true">
